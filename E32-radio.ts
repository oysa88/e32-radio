...
namespace pxtlora {
    ...
    */
    ...
    //% m0.defl=DigitalPin.P9 m1.defl=DigitalPin.P8 aux.defl=DigitalPin.P15 tx.defl=SerialPin.P14 rx.defl=SerialPin.P16 baud.defl=BaudRate.BaudRate9600 ConfigMode.defl=false
    //% group="Oppsett"
